...
void calculate_money(struct node_ty* first, double* month_earn, int possible_ending, int found_money, int hard);//算錢
void store_data(double month_earn);//把這個月賺的錢存到file裡
//maze
...
void calculate_money(struct node_ty* first, double* month_earn, int possible_ending, int found_money, int hard)
{
    //先把總金額結算好
    double money=0;
    struct node_ty* temp;
...
void store_data(double month_earn)
{
